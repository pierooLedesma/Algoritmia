...
int main() {
    ...
    cout << " se encuentra el valor " << nodo_encontrado->valor << endl << endl;


    // Verificar la eliminación de un nodo en un árbol AVL.
    arbolAVL = eliminarNodoAVL(arbolAVL, 50823147);
    mostrar_en_orden(arbolAVL);
